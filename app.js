document.addEventListener('DOMContentLoaded', () => {
  ...
  const lTetromino = [
    ...
    [0, width, (2 * width) + 1, (2 * width)],
    [width, width + 1, 2 * width, width + 2]
  ]
  const sTetromino = [
    [width + 1, width + 2, 2 * width, (2 * width) + 1],
    [1, width + 2, width + 1, (2 * width) + 2],
    [width + 1, width + 2, 2 * width, (2 * width) + 1],
    [1, width + 2, width + 1, (2 * width) + 2]
  ]
  const zTetromino = [
  ...
  const theTetrominoes = [
    lTetromino, jTetromino, sTetromino, zTetromino,
    oTetromino, iTetromino, tTetromino
  ]
  ...
  const upNextTetrominoes = [
    [0, 1, displayWidth + 1, (2 * displayWidth) + 1],
    [1, displayWidth + 1, (2 * displayWidth) + 1, 2],
    [displayWidth + 1, displayWidth + 2, 2 * displayWidth, (2 * displayWidth) + 1],
    [displayWidth, displayWidth + 1, (2 * displayWidth) + 1, (2 * displayWidth) + 2],
